    ...
    "Educación Física": {
        "competencias": [
            ...
            },
            {
                ...
                "estandares": {
                    "III CICLO": "Asume una vida saludable cuando diferencia los alimentos saludables de su dieta personal y familiar, los momentos adecuados para ingerirlos y las posturas que lo ayudan al buen desempeño en la práctica de actividades físicas, recreativas y de la vida cotidiana, reconociendo la importancia del autocuidado. Participa regularly en la práctica de actividades lúdicas identificando su ritmo cardiaco, respiración y sudoración; utiliza prácticas de activación corporal y psicológica antes de la actividad lúdica.",
                    "IV CICLO": "Asume una vida saludable cuando diferencia los alimentos de su dieta personal, familiar y de su región que son saludables de los que no lo son. Previene riesgos relacionados con la postura e higiene conociendo aquellas que favorecen y no favorecen su salud e identifica su fuerza, resistencia y velocidad en la práctica de actividades lúdicas. Adapta su esfuerzo en la práctica de actividad física de acuerdo a las características de la actividad y a sus posibilidades, aplicando conocimientos relacionados con el ritmo cardiaco, la respiración y la sudoración. Realiza prácticas de activación corporal y psicológica, e incorpora el autocuidado relacionado con los ritmos de actividad y descanso para mejorar el funcionamiento de su organismo.",
            ...
            },
            {
                ...
                "estandares": {
                    ...
                    "IV CICLO": "Interactúa a través de sus habilidades sociomotrices al tomar acuerdos sobre la manera de jugar y los posibles cambios o conflictos que se den y propone adaptaciones o modificaciones para favorecer la inclusión de sus compañeros en actividades lúdicas, aceptando al oponente como compañero de juego. Adapta la estrategia de juego anticipando las intenciones de sus compañeros y oponentes para cumplir con los objetivos planteados. Propone reglas y las modifica de acuerdo a las necesidades del contexto y los intereses del grupo en la práctica de actividades físicas.",
    ...
    "Matemática": {
        "competencias": [
            ...
            },
            {
                ...
                "estandares": {
                    "III CICLO": "Resuelve problemas relacionados con datos cualitativos en situaciones de su interés, recolecta datos a través de preguntas sencillas, los registra en listas o tablas de conteo simple (frecuencia) y los organiza en pictogramas horizontales y gráficos de barras simples. Lee la información contenida en estas tablas o gráficos identificando el dato o datos que tuvieron mayor o menor frecuencia y explica sus decisiones basándose en la información producida. Expresa la ocurrencia de sucesos cotidianos usando las nociones de posible o imposible y justifica su respuesta.",
                    "IV CICLO": "Resuelve problemas relacionados con datos cualitativos o cuantitativos (discretos) sobre un tema de estudio, recolecta datos a través de encuestas y entrevistas sencillas, registra en tablas de frecuencia simples y los representa en pictogramas, gráficos de barra simple con escala (múltiplos de diez). Interpreta información contenida en gráficos de barras simples y dobles y tablas de doble entrada, comparando frecuencias y usando el significado de la moda de un conjunto de datos; a partir de esta información, elabora algunas conclusiones y toma decisiones. Expresa la ocurrencia de sucesos cotidianos usando las nociones de seguro, más probable, menos probable, y justifica su respuesta.",
                    "V CICLO": "Resuelve problemas relacionados con temas de estudio, en los que reconoce variables cualitativas o cuantitativas discretas, recolecta datos a través de encuestas y de diversas fuentes de información. Selecciona tablas de doble entrada, gráficos de barras dobles y gráficos de líneas, seleccionando el más adecuado para representar los datos. Usa el significado de la moda para interpretar información contenida en gráficos y en diversas fuentes de información. Realiza experimentos aleatorios, reconoce sus posibles resultados y expresa la probabilidad de un evento relacionando el número de casos favorables y el total de casos posibles. Elabora y justifica predicciones, decisiones y conclusiones, basándose en la información obtenida en el análisis de datos o en la probabilidad de un evento."
                },
                "desempenos": {
                    "1° GRADO": [
            ...
            },
            {
                ...
                "desempenos": {
                    ...
                    "4° GRADO": [
                        ...
                        "Describe las diferentes zonas climáticas y señala que se forman por la distribución de la energía del sol sobre la Tierra y su relief.",
        ...
        "competencias": [
            {
                ...
                "estandares": {
                    "III CICLO": "Descubre el amor de Dios en la creación y lo relaciona con el amor que recibe de las personas que lo rodean. Explica la presencia de Dios en el Plan de Salvación y la relación que Él establece con el ser humano. Convive de manera fraterna con el prójimo respetando las diferentes expresiones religiosas. Asume las consecuencias de sus acciones con responsabilidad, comprometiéndose a ser mejor persona, a ejemplo de Jesucristo.",
                    "IV CICLO": "Describe el amor de Dios presente en la creación y en el Plan de Salvación. Construye su identidad como hijo de Dios desde el mensaje de Jesús presente en el Evangelio. Participa en la Iglesia como comunidad de fe y de amor, respetando la dignidad humana y las diversas manifestaciones religiosas. Fomenta una convivencia armónica basada en el diálogo, el respeto, la tolerancia y el amor fraterno.",
                    "V CICLO": "Comprende el amor de Dios desde la creación respetando la dignidad y la libertad de la persona humana. Explica la acción de Dios presente en el Plan de Salvación. Demuestra su amor a Dios y al prójimo participando en su comunidad y realizando obras de caridad que le ayudan en su crecimiento personal y espiritual. Fomenta una convivencia cristiana basada en el diálogo, el respeto, la tolerancia y el amor fraterno fortaleciendo su identidad como hijo de Dios."
                },
                "desempenos": {
                    "1° GRADO": [
...
def obtener_estandar(area: str, competencia_nombre: str, grado_o_ciclo: str):
    ...
    ciclo_key = ciclo.replace(" ", "_")
    
    if area in CNEB_PRIMARIA and "competencias" in CNEB_PRIMARIA[area]:
        for c in CNEB_PRIMARIA[area]["competencias"]:
            if c["nombre"].strip().upper() == competencia_nombre.strip().upper():
                estandares = c.get("estandares", {})
                return estandares.get(ciclo, estandares.get(ciclo_key, "Estándar oficial del CNEB."))
    return "Estándar oficial del CNEB."
...
def obtener_desempenos(area: str, competencia_nombre: str, grado: str):
    ...
    grado_num = str(grado).replace("°", "").replace("GRADO", "").replace("grado", "").strip()
    grado_key_1 = f"{grado_num}° GRADO"
    grado_key_2 = f"{grado_num}_GRADO"

    if area in CNEB_PRIMARIA and "competencias" in CNEB_PRIMARIA[area]:
        for c in CNEB_PRIMARIA[area]["competencias"]:
            if c["nombre"].strip().upper() == competencia_nombre.strip().upper():
                desempenos = c.get("desempenos", {})
                return desempenos.get(grado_key_1, desempenos.get(grado_key_2, ["Desempeño oficial del CNEB."]))
    return []
